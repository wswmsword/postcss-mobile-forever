    ...
    <main class="main">
      <div class="top">
        <div class="bg-title-wrapper DEMO_MODE">
          <div class="bg-title">
            <span v-for="letter, i in letters" :style="{transform: `rotate(${i * 5}deg)`}" :key="i">{{letter}}</span>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      title: "Vue Mobile Viewport",
      letters: ['✨', ' '].concat("Vue Mobile Viewport".split(''), '🐰', ' ', '🐱'),
    }
  }
}
</script>
