...
module.exports = postcss.plugin("postcss-px-to-media-viewport", function(options) {
  ...
  return function(css, result) {
    ...
    let sharedAtRult = postcss.atRule({ name: "media", params: `(min-width: ${yAxisBreakPoint}px), (orientation: landscape) and (max-width: ${yAxisBreakPoint}px) and (min-width: ${landscapeWidth}px)`, nodes: [] });
